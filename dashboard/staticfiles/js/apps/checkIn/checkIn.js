                            ...
                            '<li class="row check-in-row" year="'+this_year+'" month="'+this_month+'" day="'+day_count+'">'+
                                ...
                                '<div class="col-md-6 check-in-slots" year="'+this_year+'" month="'+this_month+'" day="'+day_count+'">'+
                                    '<div check_id="none">'+
                                        ...
                                        '<input type="time" class="form-control col-md-2 input-required check-in-element" order ="1" day="'+day_count+'" month="'+this_month+'" style="float:left;border-radius: 10px;font-size: 20px; text-align: center; padding-top: 0.8%; " '+dis+' required>'+
                                        '<input type="time" class="form-control col-md-2 input-required check-out-element" order ="1" day="'+day_count+'" month="'+this_month+'" style="margin-left:2%; float:left;border-radius: 10px;font-size: 20px; text-align: center; padding-top: 0.8%; " '+dis+' required>'+
                                        ...
                                        '<li class="row check-in-row" year="'+this_year+'" month="'+this_month+'" day="'+day_count+'">'+
                                            ...
                                            '<div class="col-md-6 check-in-slots" year="'+this_year+'" month="'+this_month+'" day="'+day_count+'">'+
                                                '<div check_id="'+data.slots[i]['pk']+'">'+
                                                    ...
                                                    '<input type="time" class="form-control col-md-2 input-required check-in-element" order="'+order+'" day="'+day_count+'" month="'+this_month+'" style="float:left;border-radius: 10px;font-size: 20px; text-align: center; padding-top: 0.8%; " value="'+cih+':'+cim+'" required>'+
                                                    '<input type="time" class="form-control col-md-2 input-required check-out-element" order="'+order+'" day="'+day_count+'" month="'+this_month+'" style="margin-left:2%; float:left;border-radius: 10px;font-size: 20px; text-align: center; padding-top: 0.8%; " value="'+coh+':'+com+'" required>'+
                                    ...
                                    $('.check-in-slots').each(function(){
                                        if (($(this).attr('year') == this_year) && ($(this).attr('month') == this_month) && ($(this).attr('day') == day_count)) {
                                            ...
                                            $(this).append(
                                                ...
                                                '<div check_id="'+data.slots[i]['pk']+'">'+
                                                    '<i class="fas fa-info-circle edited-modal" style="float:left; margin-right: 2%; font-size: 22px; margin-top: 1%; visibility:'+visibility+'; cursor:pointer;" check_id="'+data.slots[i]['pk']+'" data-toggle="modal" data-target="#edited_traceability"></i>'+
                                                    '<input type="time" class="form-control col-md-2 input-required check-in-element" order="'+order+'" month="'+this_month+'" day="'+day_count+'" style="float:left;border-radius: 10px; font-size: 20px; text-align: center; padding-top: 0.8%; " value="'+cih+':'+cim+'" required>'+
                                                    '<input type="time" class="form-control col-md-2 input-required check-out-element" order="'+order+'" month="'+this_month+'" day="'+day_count+'" style="margin-left:2%; float:left;border-radius: 10px; font-size: 20px; text-align: center; padding-top: 0.8%; " value="'+coh+':'+com+'" required>'+
                                                    '<button type="button" style="margin-left: 2%; border-radius: 26px; font-weight: bold; display:none;" order="'+order+'" year="'+this_year+'" month="'+this_month+'" day="'+day_count+'" check_id="'+data.slots[i]['pk']+'" class="edit_check_in btn btn-primary btn-md remove-element">Modificar</button>'+
                                                    '<button type="button" style="margin-left: 1%; border-radius: 26px; font-weight: bold; display:none;" order="'+order+'" day="'+day_count+'" class="btn btn-danger btn-md remove-element cancel_edit_check_in"><i class="fas fa-close"></i></button>'+
                                                '</div>'
                                            )
                                    ...
                                    $('#slot_list').append(
                                        '<li class="row check-in-row" year="'+this_year+'" month="'+this_month+'" day="'+day_count+'">'+
                                            ...
                                            '<div class="col-md-6 check-in-slots" year="'+this_year+'" month="'+this_month+'" day="'+day_count+'">'+
                                                '<div check_id="none">'+
                                                    '<i class="fas fa-umbrella-beach edited-modal" style="float:left; margin-right: 1.3%; font-size: 22px; margin-top: 1%;" title="Vacaciones"></i>'+
                                                    '<input type="time" class="form-control col-md-2 input-required check-in-element" order="'+order+'" day="'+day_count+'" month="'+this_month+'" style="float:left;border-radius: 10px;font-size: 20px; text-align: center; padding-top: 0.8%; " '+dis+' required>'+
                                                    '<input type="time" class="form-control col-md-2 input-required check-out-element" order="'+order+'" day="'+day_count+'" month="'+this_month+'" style="margin-left:2%; float:left;border-radius: 10px;font-size: 20px; text-align: center; padding-top: 0.8%; " '+dis+' required>'+
                                                    add+
                                                    '<button type="button" style="margin-left: 2%; border-radius: 26px; font-weight: bold; display:none;" order="'+order+'" year="'+this_year+'" month="'+this_month+'" day="'+day_count+'" check_id="'+data.slots[i]['pk']+'" class="edit_check_in btn btn-primary btn-md remove-element">Modificar</button>'+
                                                    '<button type="button" style="margin-left: 1%; border-radius: 26px; font-weight: bold; display:none;" order="'+order+'" day="'+day_count+'" class="btn btn-danger btn-md remove-element cancel_edit_check_in"><i class="fas fa-close"></i></button>'+
                                                '</div>'+
                        ...
                        $('#slot_list').append(
                            '<li class="row check-in-row" year="'+this_year+'" month="'+this_month+'" day="'+w+'">'+
                                ...
                                '<div class="col-md-6 check-in-slots" year="'+this_year+'" month="'+this_month+'" day="'+w+'">'+
                                    '<div check_id="none">'+
                                        '<i class="fas fa-umbrella-beach edited-modal" style="float:left; margin-right: 1.3%; font-size: 22px; margin-top: 1%;" title="Vacaciones"></i>'+
                                        '<input type="time" class="form-control col-md-2 input-required check-in-element" order ="1" day="'+w+'" month="'+this_month+'" style="float:left;border-radius: 10px;font-size: 20px; text-align: center; padding-top: 0.8%; " '+dis+' required>'+
                                        '<input type="time" class="form-control col-md-2 input-required check-out-element" order ="1" day="'+w+'" month="'+this_month+'" style="margin-left:2%; float:left;border-radius: 10px;font-size: 20px; text-align: center; padding-top: 0.8%; " '+dis+' required>'+
