...
function festivos() {
    ...
    var fest21 = ((moment('2023-05-03', 'YYYY-MM-DD')).format('YYYY-MM-DD')).toString()
    var fest28 = ((moment('2023-06-08', 'YYYY-MM-DD')).format('YYYY-MM-DD')).toString()
    ...
    $('.grid-cell-gb.ok').each(function () {
        ...
        if ($(this).attr('date') == fest1 || $(this).attr('date') == fest2 || $(this).attr('date') == fest3 || $(this).attr('date') == fest4 || $(this).attr('date') == fest5 || $(this).attr('date') == fest6 || $(this).attr('date') == fest7 || $(this).attr('date') == fest8 || $(this).attr('date') == fest9 || $(this).attr('date') == fest10 || $(this).attr('date') == fest11 || $(this).attr('date') == fest12 || $(this).attr('date') == fest13 || $(this).attr('date') == fest14 || $(this).attr('date') == fest15 || $(this).attr('date') == fest16 || $(this).attr('date') == fest17 || $(this).attr('date') == fest18 || $(this).attr('date') == fest19 || $(this).attr('date') == fest20 || $(this).attr('date') == fest21 || $(this).attr('date') == fest22 || $(this).attr('date') == fest23 || $(this).attr('date') == fest24 || $(this).attr('date') == fest25 || $(this).attr('date') == fest26 || $(this).attr('date') == fest27 || $(this).attr('date') == fest28) {
