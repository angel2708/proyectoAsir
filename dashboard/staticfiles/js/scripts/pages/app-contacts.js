$(document).ready(function() {
    ...
    // Datatable
    var userDataTable = $('#users-contacts').DataTable({'order' : [[1,'desc']]});
    ...
    $(document).on("click", ".filtr", function() {
        userDataTable.order([1, 'asc']).draw();
    });
    */

    $(document).on("click", ".all-customer", function() {
    ...
    $(document).on("click", ".filtrar", function() {
        userDataTable.columns( 1 ).search( 1 ).draw();
        $(".all-customer").removeClass("active");
        $(".favorites").removeClass("active");
    ...
    $('.add-contact-item').on( 'click', function (e) {
        ...
        e.preventDefault();
        var id = $('.cliente-codigo').val();
        var name = $(".cliente-nombre").val();
        var email = $(".cliente-email").val();
        var contact = $(".cliente-telefono").val();
        var web = $(".cliente-web").val();
        ...
        userDataTable.row.add( [
            ...
            '<div class="media">'+
                '<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="../../../dashboard/staticfiles/images/portrait/small/img_user_not_found.png" alt="avatar"><i></i></span></div>'+
            ...
            '<a data-toggle="modal" data-target="#EditContactModal" class="primary edit mr-1"><i class="fa fa-pen"></i></a>'+
                '<a class="danger delete mr-1"><i class="fa fa-trash"></i></a>'+
                '<span class="dropdown">'+
    ...
    $('#edit-contact-item').on( 'click', function (e) {
        ...
        userDataTable.row(currentRow).data( [
            '<input type="checkbox" class="input-chk check">',
            '<div class="media">'+
                '<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="../../../staticfiles/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span></div>'+
                '<div class="media-body media-middle">'+
                    '<a class="name" class="media-heading">'+name+'</a>'+
                '</div>'+
            '</div>',
